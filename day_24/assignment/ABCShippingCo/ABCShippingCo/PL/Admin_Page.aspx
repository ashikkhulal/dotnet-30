...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <h5>Note: Using frontend way to get data:</h5>
        ...
        <div>
            <h5>Note: Using backend way (sqlDataReader class) to get data:</h5>
            <asp:GridView ID="Gv_admin2" runat="server" OnLoad="Gv_admin2_Load"></asp:GridView>
        </div>
        <div>
            <h5>Note: Using backend way (sqlDataAdapter class) to get data:</h5>
            <asp:GridView ID="Gv_admin3" runat="server" OnLoad="Gv_admin3_Load"></asp:GridView>
        </div>
    </form>
</body>
</html>
